...
public class Add_Tag extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Lecture", "Tutorial", "Lab" }));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String tRelatedTag = jComboBox1.getSelectedItem().toString();
        

        try{

            if(tname.equals("")||tcode.equals("") || tRelatedTag.equals("") ){  //Input field validation

                JOptionPane.showMessageDialog(this, "Input fields cannot be empty","Error",JOptionPane.ERROR_MESSAGE);
            }else{

                MY_CONNECTION.setData("Insert into tag values('0','"+jTextField1.getText()+"','"+jTextField2.getText()+"','"+jComboBox1.getSelectedItem().toString()+"')");
                //table_update();
                jTextField1.setText("");
                jTextField2.setText("");
